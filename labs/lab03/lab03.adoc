...
----
+
Note: If you've used Spring Boot 1.x please see link:Spring Boot 2.0 Migration-Guide here [https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-2.0-Migration-Guide]. Some properties like autoconfig were renamed in spring-boot-2.0
+
