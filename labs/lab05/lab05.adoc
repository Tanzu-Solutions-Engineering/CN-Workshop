...
. For the 2nd half of this lab we'll need our `cloud-native-spring-lab05` Maven artifact accessible in our local Maven repository. Rebuild and install the artifact with the following command:
+
[source,bash]
----
...
[source,bash]
----
CN-Workshop/labs/my_work/cloud-native-spring-lab05 $ cf push
----
