...
* https://www.oracle.com/technetwork/java/javase/downloads/index.html[Java JDK 8]
* Your favorite IDE or editor (e.g., https://www.eclipse.org[Eclipse] or https://spring.io/tools[Spring Tool Suite], https://www.jetbrains.com/idea[IntelliJ IDEA], https://netbeans.org[NetBeans], Visual Studio, etc)
...
* Login or signup for a free https://run.pivotal.io[Pivotal Web Services] account
...
[source,bash]
----
$ git clone https://github.com/yogendra/CN-Workshop.git
----
